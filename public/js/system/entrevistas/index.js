/*-----------------------------------------------ESTE ARCHIVO DE JAVASCRIPT ES PARA LA FUNCIONALIDADES DE LA VISTA DEL MODULO DE ENTREVISTAS -------------------------------------------------------------------------*/
$(function() {
...
function buscarEventoCad(e) {
	...
	fetch(base_url_js+'Entrevistas/buscarPorCadena', {
		method: 'POST',
		body: myform
	})
...
function hideShowColumn(col_name){	
	...
	fetch(base_url_js+'Entrevistas/setColumnFetch', {
			method: 'POST',
			body: myform
		})
	.then(function(response){
