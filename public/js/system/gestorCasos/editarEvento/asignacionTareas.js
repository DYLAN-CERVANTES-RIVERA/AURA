        ...
        case 'BARRIDO':
            ...
            <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <span class="span_rem_ans" style="word-wrap: break-word;">${data.descripcion}</span>
                    </div>
                    <div class="col-lg-12">
        ...
        case 'BUSQUEDA':
            ...
            <a class="subtitulo-azul-grueso">REPORTE BUSQUEDA.</a>
                <div class="row">
                    <div class="col-lg-12">
                        <span class="span_rem">DESCRIPCION: </span>
                        <span class="span_rem_ans" >${data.descripcion}</span>
                    </div>
                </div>
            <hr>`; 
            if(data.img!= null){
        ...
        case 'ENTREVISTA':
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <span class="span_rem_ans" >${data.nombre_entrevistado}</span>
                </div>
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    ...
                    <span class="span_rem_ans" style="word-wrap: break-word;">${data.tipo_entrevistado}</span>
                </div>
                <div class="col-lg-12">
                    <span class="span_rem">ENTREVISTA: </span>
                    <span class="span_rem_ans" >${data.entrevista}</span>
                </div>
            </div>
            <hr>
        `;   
