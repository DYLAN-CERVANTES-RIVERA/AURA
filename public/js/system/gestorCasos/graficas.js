...
const getDataGraficas = () => {
    ...
    formAux.append("filtroActual", document.getElementById('filtroActual').value)
    fetch(base_url_js + 'GestorCasos/getDatagraficas', {//REALIZA UN FETCH PARA GENERAR LAS GRAFICAS CON LOS FILTROS PUESTOS EN LA INTERFAZ
            method: 'POST',
            body: formAux
        })
        .then(resp => resp.json())
