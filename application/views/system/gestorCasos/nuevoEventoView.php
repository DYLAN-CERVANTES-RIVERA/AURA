        ...
        <form id='datos_principales' onsubmit="event.preventDefault()">
            ...
            <div class="row mt-3">
                ...
                <div class="form-group col-lg-3 col-sm-6 ">
                    ...
                    <input style="color: #002f6c;" type="text" name="911_principales" id="911_principales"  maxlength="20" class="form-control" placeholder="Ingrese el Folio 911" onkeypress="return valideKey(event);">
