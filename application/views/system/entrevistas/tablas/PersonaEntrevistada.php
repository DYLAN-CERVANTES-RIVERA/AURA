    ...
    <div class="col-12 my-4" id="msg_principales"></div>
        <div class="row mt-2">
            ...
            <div class="col-lg-5 col-sm-6 ">
                <span class="span_rem ">Elemento Que Capturo Persona Entrevistada: </h5>
                <input  style="font-size: 15px;color: #0F2145; text-align:center;" type="text" name="captura_dato_entrevista" id="captura_dato_entrevista" name="captura_dato_entrevista" value=""class="form-control custom-input_dt text-uppercase" disabled="true">
        ...
        <div class="row mt-2">
            <div class="col-6">
                <span class="span_rem">¿Desea corregir la información de la persona con una remision de SARAI?</h5>
            </div>
            <div class="col-3">
        ...
        <div class="form-row mt-3">
            <h5 class="titulo-azul col-lg-12 mt-3">Foto del Entrevistado</h5>
            <div class="form-group col-lg-12 col-sm-6">
                <div class="d-flex justify-content-around" id="uploadFileFotoDetenido">
            ...
            <div class="form-group col-lg-4 col-sm-6">
                <label for="nombre" class="subtitulo-rosa">Nombre del Entrevistado:</label>
            ...
            <div class="form-group col-lg-4 col-sm-6">
                <label for="ap_paterno" class="subtitulo-rosa">Apellido Paterno del Entrevistado:</label>
            ...
            <div class="form-group col-lg-4 col-sm-6">
                <label for="ap_materno" class="subtitulo-rosa">Apellido Materno del Entrevistado:</label>
            ...
            <div class="form-group col-lg-12">
                <label for="detenido_por" class="label-form subtitulo-rosa">Delitos del Entrevistado:</label>
            ...
            <div class="form-group col-lg-12">
                <label for="asociado_a" class="label-form subtitulo-rosa">Antecendentes Asociados del Entrevistado:</label>
            ...
            <div class="form-group col-lg-12">
                <label for="alias" class="label-form subtitulo-rosa">Alias del Entrevistado:</label>
            ...
            <div class="form-group col-lg-12">
                <label for="remisiones" class="label-form subtitulo-rosa">Remisiones del Entrevistado:</label>
        ...
        <div class="form-group col-lg-8 col-sm-3">
            <label for="Asignado" class="subtitulo-rosa">Asinado a:</label>
            <input type="text" class="form-control form-control-sm text-uppercase" maxlength="100" id="Asignado" name="Asignado" placeholder="Ingrese a quien se va asignar" onkeypress="return valida(event);">
            <span class="span_error" id="Asignado_error"></span>
        </div>

        <h5 class="titulo-azul mt-3">Relevante</h5>
        <div class="form-group col-lg-12 col-sm-3">
            <label for="relevante" class="subtitulo-rosa">Es relevante?</label>   
            <div class=" row col-lg-12">
              
                <div class="form-check col-lg-6">
                    <input class="form-check-input" type="radio" name="Relevancia_Si_No" id="id_relevancia_1" value="1"  >
                    <label class="form-check-label" for="id_relevancia_1">Si</label>
                </div>
            
                <div class="form-check col-lg-6">
                    <input class="form-check-input" type="radio" name="Relevancia_Si_No" id="id_relevancia_2" checked value="0"  >
                    <label class="form-check-label" for="id_relevancia_2">No</label>
                </div>
            </div>
        </div>

        <div class="modal fade" id="ModalCenterPrincipal" tabindex="-1" role="dialog" aria-labelledby="myModalExito" aria-hidden="true" >
