<!--vista del modulo de seguimientos Redes de Vinculo de casos -->
<div class= "content">
    <div class="cabecera_modulo" ><br></div>
    <h1 class="cabecera_modulo text-center"><strong>
                    <?php
        ...
        <div class="container col-lg-10 mt-1 mb-1">
                ...
                <div class="col-6 col-lg-auto mr-lg-auto my-2 my-lg-auto d-flex justify-content-center">
                    <div class="row col-4">
                        <div id="buttonsExport" class="col-12">
                            ...
                            <a id="id_link_pdf" href="<?= base_url ?>Seguimientos/exportarInfo/?tipo_export=<?= "PDF".$cadenaExport.$filtroActual; ?>" target="_blank" class="btn mi_hide" data-toggle="tooltip" data-placement="bottom" title="Exportar a PDF">
            ...
            <div class="row d-flex justify-content-center mt-3">
                <div class="col-auto">
                    ...
                    <div class="chip-azul">
                        <span class="v-a-middle" >
                            <?php
                                if (isset($_SESSION['userdataSIC']->rango_inicio_sg)) {
                                    $r_inicio = $_SESSION['userdataSIC']->rango_inicio_sg;
                                    $r_fin = $_SESSION['userdataSIC']->rango_fin_sg;
                ...
                <?php
                    if (isset($_SESSION['userdataSIC']->rango_inicio_sg)) {
                        ?>
                            <a class="btn btn-opacity" href="<?= base_url;?>Seguimientos/removeRangosFechasSesion/?filtroActual=<?= $data['filtroActual'];?>">mostrar todo</a>
                        <?php
                    }
                ?>
            </div>
